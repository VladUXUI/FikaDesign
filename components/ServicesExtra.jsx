    ...
    <section id="services" ref={ref} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a href="/services" className="btn btn-secondary" style={{ flexShrink: 0, pointerEvents: "auto" }}>
            Full service detail →
          </a>
        </div>
        <style>{`
...
function KineticNav({ active, onJump, motion, bouncy }) {
  ...
  return (
    <div className="horizontal-nav-bar" style={{
      ...
      {/* CTA on the right */}
      <a href="/services" className="btn btn-secondary" style={{
...
export { ServicesTypeTicker, ServicesAccordion, ServicesHorizontal };
