...
import { useReveal, useScrollY, useElementProgress, clamp } from "./hooks";
...
function StudioCopy({ motion }) {
  ...
  return (
    <div ref={ref} className={motion === "off" ? "" : "reveal"}>
      ...
      <a href="/about" className="btn btn-on-ink">About us →</a>
    </div>
  );
}
  ...
  return (
    <div style={{ position: "relative", width: "100%", aspectRatio: "1 / 1" }}>
      ...
      <div style={{
        ...
        <img src="/Adina_avatar.png" alt="Adina Cretu — Fika Design Co." style={imgStyle} />
      </div>
      ...
      <div style={{
        ...
        <img src="/Vlad_Avatar.png" alt="Vlad Todirut — Fika Design Co." style={imgStyle} />
      </div>
    </div>
  );
}
