...
import { useReveal, useScrollY, clamp } from "./hooks";
import { SkoutaPhonePreview } from "./Hero";
  ...
  return (
    <div ref={ref} className={motion === "off" ? "" : "reveal"}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
        <img src="/SkoutaLogo.svg" alt="" aria-hidden="true" style={{ width: 28, height: 28, display: "block" }} />
        <span style={{
      ...
      <a href="/work" className="btn btn-primary">Read the case study →</a>
    </div>
  );
}
