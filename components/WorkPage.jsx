      ...
      <div className="container">
        ...
        <div style={{ marginBottom: 80, paddingBottom: 56, borderBottom: "1px solid var(--bd-line)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 28 }}>
            <img src="/SkoutaLogo.svg" alt="" aria-hidden="true" style={{ width: 36, height: 36, display: "block" }} />
            <span style={{
        ...
        <div className="case-study-grid" style={{
          ...
          <aside className="case-study-rail" style={{ position: "sticky", top: 120, alignSelf: "flex-start" }}>
            ...
            <a href="/contact" className="btn btn-secondary" style={{ marginTop: 32, height: 44, padding: "0 18px", fontSize: 14 }}>
              Discuss a project →
            </a>
          </aside>
...
function PipCard() {
  return (
    <div style={{
      ...
      <img src="/SkoutaLogo.svg" alt="Pip — the Skouta bird" style={{ width: 96, height: 96, display: "block" }} />
      <div>
    ...
    <section className="section-ink" style={{ paddingTop: 120, paddingBottom: 120 }}>
      <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <a href="/services" className="btn btn-on-ink">See services</a>
          <a href="/contact" className="btn btn-on-orange-ghost">Get in touch →</a>
        </div>
      </div>
    </section>
  );
