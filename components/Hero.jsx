    ...
    <div style={{ width: DISPLAY_W, height: DISPLAY_H }}>
      <div style={{
        ...
        <div style={{
          ...
          {/* Inner screen — Skouta app screenshot fills the phone. Background
              matches the bezel so the rounded corners blend in. */}
          <img
            src="/skouta-phone.png"
            alt="Skouta — real-time English-language app for Swedish public alerts"
            style={{
...
export { Hero, SkoutaPhonePreview };
