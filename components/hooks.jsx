 ...
 */
function useScrollY() {
  // Start at 0 to match the server-rendered HTML, then sync to the real scroll
  // position after mount — reading window.scrollY during the initial render
  // would cause a hydration mismatch on an already-scrolled page.
  ...
  useEffect(() => {
    ...
    setY(window.scrollY); // initial sync after hydration
...
export { useScrollY, useElementProgress, useReveal, lerp, clamp };
