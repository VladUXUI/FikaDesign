...
function LegalPage({ kind }) {
  // Legal pages use the calmer "subtle" motion mode (parity with the
  // original static pages); restore "bold" on unmount.
  React.useEffect(() => {
    document.body.setAttribute("data-motion", "subtle");
    return () => document.body.setAttribute("data-motion", "bold");
  }, []);
  return (
    <>
      <Nav />
        ...
        <div className="container">
          <div style={{
            ...
            <aside style={{ position: "sticky", top: 120 }}>
              ...
              <a href="/contact" className="btn btn-secondary" style={{ height: 44, padding: "0 18px", fontSize: 14 }}>
                Contact us →
              </a>
            </aside>
