...
import { useScrollY, useReveal, clamp } from "./hooks";
import { ServicesTypeTicker, ServicesAccordion, ServicesHorizontal } from "./ServicesExtra";
    ...
    <section id="services" ref={ref} style={{
      ...
      <div style={{
        ...
        <div className="container" style={{
          ...
          <a href="/services" className="btn btn-secondary services-cta-desktop" style={{ flexShrink: 0 }}>
            Full service detail →
          </a>
        </div>
        ...
        <div className="container services-stage" style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14, paddingTop: 8 }}>
            ...
            <a href="/services" className="btn btn-secondary services-cta-mobile" style={{ marginTop: 8 }}>
              Full service detail →
            </a>
          </div>
    ...
    <section id="services" className="section section-paper" style={{ paddingTop: 140, paddingBottom: 140 }}>
      <div className="container">
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 64, gap: 32 }}>
          ...
          <a href="/services" className="btn btn-secondary">Full service detail →</a>
        </div>
